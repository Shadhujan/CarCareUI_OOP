...
public class VehicleSalesManagementSystemUI extends javax.swing.JFrame {

    DefaultTableModel model;
    Vehicle ObjVehicle;
    VehicleController ObjController;
    ArrayList<Vehicle> VehicleList;
    int index;

    public VehicleSalesManagementSystemUI() {
        initComponents();

        ObjController = new VehicleController();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cus Name", "Cus ID", "Cus Mail", "Vehicle ID", "Price(LKR)", "Quantity", "Total(LKR)"
            }
        ) {
        ...
        jLabel1.setText("Search By Vehicle ID");
    ...
    private void bSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSearchActionPerformed
        try {
            String searchVehicle = txtSearch.getText();
            for (Vehicle W : VehicleList) {
                if (W.getVID().contains(searchVehicle)) {
                    JOptionPane.showMessageDialog(rootPane, W.toString(), "Info ", 0);
                    return;
                }
            }
            JOptionPane.showMessageDialog(rootPane, "Vehicle Details Not Found", "Info ", 0);
    ...
    private void bUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bUpdateActionPerformed
        ...
        if (jTable1.getSelectedRowCount() == 1) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Updated a Vehicle", "Sucess", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDeleteActionPerformed
        if (jTable1.getSelectedRowCount() == 1) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Deleted a Vehicle", "Sucess", JOptionPane.INFORMATION_MESSAGE);
            index--;
        } else {
            if (jTable1.getSelectedRowCount() == 0) {
                JOptionPane.showMessageDialog(rootPane, "Table Is Empty", "Info", 0);
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        try {
            ...
            index++;
            ObjVehicle = ObjController.addVehicle(WID, CName, CID ,CMail , Quantity, Price);
            txtTotal.setText(String.valueOf(ObjVehicle.CalTotal()));
            ...
            JOptionPane.showMessageDialog(rootPane, "Added Vehicle " + index, "Sucess", JOptionPane.INFORMATION_MESSAGE);
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(rootPane, "Invalid User Input", "Error", 0);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VehicleSalesManagementSystemUI().setVisible(true);
            }
        });
    }
